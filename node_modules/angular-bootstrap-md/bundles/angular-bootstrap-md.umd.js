(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/router'), require('chart.js'), require('@angular/animations'), require('tslib'), require('@angular/forms'), require('rxjs'), require('@angular/common'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/router', 'chart.js', '@angular/animations', 'tslib', '@angular/forms', 'rxjs', '@angular/common', '@angular/core'], factory) :
    (factory((global['angular-bootstrap-md'] = {}),global.ng.router,global.Chart,global.ng.animations,global.tslib,global.ng.forms,global.Rx,global.ng.common,global.ng.core));
}(this, (function (exports,router,Chart,animations,tslib,forms,rxjs,common,core) { 'use strict';
